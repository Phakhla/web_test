...
<div class="container mt-5">
    <div class="row">
        <div class="text-center col-md-4">
            <i class="mb-3 fas fa-home fa-3x text-success"></i>
        ...
        <div class="text-center col-md-4">
            <i class="mb-3 fas fa-concierge-bell fa-3x text-warning"></i>
        ...
        <div class="text-center col-md-4">
            <i class="mb-3 fas fa-cloud-showers-heavy fa-3x text-danger"></i>
